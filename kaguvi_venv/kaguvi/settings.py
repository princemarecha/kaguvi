"""
Django settings for kaguvi project.
...
SECRET_KEY = 'jcnriyo2i6qc_j34qrp(0^00p$v^v+bi9m+uzytj1e*#767h&3'
...
CART_SESSION_ID = 'cart'    #name of the session

EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'apikey'
EMAIL_HOST_PASSWORD = 'apnbqonkcbkwxevw'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_EMAIL_FROM = 'Kaguvi Store <pmanstylz@gmail.com>'
...
WSGI_APPLICATION = 'kaguvi.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'static' #static folder should be in main directory
]
MEDIA_URL = '/media/'
